...
class SDK {
   ...
   */
  instruments(metadata?: types.InstrumentsMetadataParam): Promise<FetchResponse<200, types.InstrumentsResponse200>> {
    return this.core.fetch('/api/futures/supported-exchange-pairs', 'get', metadata);
  }
  ...
  get_endpoint(metadata: types.GetEndpointMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/spot/orderbook/large-limit-order-history', 'get', metadata);
  }
  ...
  get_apifuturesdelistedExchangePairs(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/delisted-exchange-pairs', 'get');
  }

  get_apifutureswhaleIndexhistory(metadata: types.GetApifutureswhaleIndexhistoryMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/whale-index/history', 'get', metadata);
  }

  get_apifuturescgdiIndexhistory(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/cgdi-index/history  ', 'get');
  }

  get_apifuturescdriIndexhistory(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/cdri-index/history ', 'get');
  }

  get_apiindexbitcoinSthSopr(): Promise<FetchResponse<200, types.GetApiindexbitcoinSthSoprResponse200>> {
    return this.core.fetch('/api/index/bitcoin-sth-sopr', 'get');
  }

  get_apiindexbitcoinSthRealizedPrice(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-sth-realized-price', 'get');
  }

  get_apiindexbitcoinLthRealizedPrice(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-lth-realized-price', 'get');
  }

  get_apiindexbitcoinRhodlRatio(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-rhodl-ratio', 'get');
  }

  get_apiindexbitcoinShortTermHolderSupply(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-short-term-holder-supply', 'get');
  }

  get_apiindexbitcoinLongTermHolderSupply(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-long-term-holder-supply', 'get');
  }

  get_apiindexbitcoinNewAddresses(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-new-addresses', 'get');
  }

  get_apiindexbitcoinActiveAddresses(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-active-addresses', 'get');
  }

  get_apiindexbitcoinReserveRisk(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-reserve-risk', 'get');
  }

  get_apiindexbitcoinNetUnrealizedProfitLoss(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-net-unrealized-profit-loss', 'get');
  }

  get_apiindexbitcoinCorrelation(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-correlation', 'get');
  }

  get_apiindexbitcoinMacroOscillator(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-macro-oscillator', 'get');
  }

  get_apiindexoptionVsFuturesOiRatio(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/option-vs-futures-oi-ratio', 'get');
  }

  get_apiindexaltcoinSeason(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/altcoin-season', 'get');
  }

  get_apiindexbitcoinVsGlobalM2Growth(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-vs-global-m2-growth', 'get');
  }

  get_apiindexbitcoinVsUsM2Growth(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-vs-us-m2-growth', 'get');
  }

  get_apiindexbitcoinLthSop(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-lth-sopr', 'get');
  }
  ...
  takerBuysellVolume(metadata: types.TakerBuysellVolumeMetadataParam): Promise<FetchResponse<200, types.TakerBuysellVolumeResponse200>> {
    return this.core.fetch('/api/futures/v2/taker-buy-sell-volume/history', 'get', metadata);
  }

  get_apiindexbitcoinDominance(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/index/bitcoin-dominance', 'get');
  }

  get_apicalendareconomic_data(metadata?: types.GetApicalendareconomicDataMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/calendar/economic-data', 'get', metadata);
  }

  get_apicalendarfinancial_events(metadata?: types.GetApicalendarfinancialEventsMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/calendar/financial-events', 'get', metadata);
  }

  get_apicalendarcentral_bank_activities(metadata?: types.GetApicalendarcentralBankActivitiesMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/calendar/central-bank-activities', 'get', metadata);
  }

  get_apifuturesv2netPositionhistory(metadata: types.GetApifuturesv2NetPositionhistoryMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/v2/net-position/history', 'get', metadata);
  }

  get_apihyperliquidposition(metadata: types.GetApihyperliquidpositionMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/hyperliquid/position', 'get', metadata);
  }

  get_apienterprisefuturesliquidationhistory(metadata: types.GetApienterprisefuturesliquidationhistoryMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/enterprise/futures/liquidation/history', 'get', metadata);
  }

  get_apienterpricefuturesglobalLongShortAccountRatiohistory(metadata: types.GetApienterpricefuturesglobalLongShortAccountRatiohistoryMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/enterprise/futures/global-long-short-account-ratio/history', 'get', metadata);
  }

  futuresLiquidationAggregatedHistory(metadata: types.FuturesLiquidationAggregatedHistoryMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/enterprise/futures/liquidation/aggregated-history', 'get', metadata);
  }

  get_apiexchange_assets_transparencylist(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/exchange_assets_transparency/list', 'get');
  }

  get_apifuturessupportedExchanges(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/supported-exchanges', 'get');
  }

  get_apifuturesliquidationmaxPain(metadata?: types.GetApifuturesliquidationmaxPainMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/liquidation/max-pain', 'get', metadata);
  }

  get_apiarticlelist(metadata?: types.GetApiarticlelistMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/article/list', 'get', metadata);
  }

  get_newEndpoint(metadata: types.GetNewEndpointMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/indicators/rsi', 'get', metadata);
  }
   ...
   *
   */
  get_apifuturesindicatorsrsi1(metadata: types.GetApifuturesindicatorsrsi1MetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/indicators/ma', 'get', metadata);
  }
   ...
   *
   */
  get_apifuturesindicatorsma1(metadata: types.GetApifuturesindicatorsma1MetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/indicators/ema', 'get', metadata);
  }
   ...
   *
   */
  get_apifuturesindicatorsema1(metadata: types.GetApifuturesindicatorsema1MetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/indicators/macd', 'get', metadata);
  }
   ...
   *
   */
  get_apifuturesindicatorsema2(metadata: types.GetApifuturesindicatorsema2MetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/indicators/boll', 'get', metadata);
  }

  get_apichainwhaleTransfer(metadata?: types.GetApichainwhaleTransferMetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/chain/v2/whale-transfer', 'get', metadata);
  }
   ...
   * data and various leverage amounts.
   *
   * @summary Copy of Liquidation Aggregated Heatmap(Enterprise)
   * @throws FetchError<400, types.GetApienterprise1Response400> 400
   */
  get_apienterprise1(metadata: types.GetApienterprise1MetadataParam): Promise<FetchResponse<200, types.GetApienterprise1Response200>> {
    return this.core.fetch('/api/enterprise/-1', 'get', metadata);
  }
   ...
   * data and various leverage amounts
   *
   * @summary Copy of Liquidation Heatmap(Enterprise)
   * @throws FetchError<400, types.GetApienterprisefuturesliquidationheatmap1Response400> 400
   */
  get_apienterprisefuturesliquidationheatmap1(metadata: types.GetApienterprisefuturesliquidationheatmap1MetadataParam): Promise<FetchResponse<200, types.GetApienterprisefuturesliquidationheatmap1Response200>> {
    return this.core.fetch('/api/enterprise/futures/liquidation/map', 'get', metadata);
  }
   ...
   *
   * @summary Copy of Liquidation Aggregated Heatmap(Enterprise)
   * @throws FetchError<400, types.GetApienterprisefuturesliquidationaggregateHeatmap1Response400> 400
   */
  get_apienterprisefuturesliquidationaggregateHeatmap1(metadata: types.GetApienterprisefuturesliquidationaggregateHeatmap1MetadataParam): Promise<FetchResponse<200, types.GetApienterprisefuturesliquidationaggregateHeatmap1Response200>> {
    return this.core.fetch('/api/enterprise/futures/liquidation/aggregate-map', 'get', metadata);
  }
   ...
   * @throws FetchError<400, types.GetApietfethereumflowHistory1Response400> 400
   */
  get_apietfethereumflowHistory1(): Promise<FetchResponse<200, types.GetApietfethereumflowHistory1Response200>> {
    return this.core.fetch('/api/etf/solana/flow-history', 'get');
  }
   ...
   * @throws FetchError<400, types.GetApietfsolanaflowHistory1Response400> 400
   */
  get_apietfsolanaflowHistory1(): Promise<FetchResponse<200, types.GetApietfsolanaflowHistory1Response200>> {
    return this.core.fetch('/api/etf/xrp/flow-history', 'get');
  }

  get_newEndpoint1(metadata: types.GetNewEndpoint1MetadataParam): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/net-position/history', 'get', metadata);
  }

  futuresVolumeFootprintHistory(): Promise<FetchResponse<number, unknown>> {
    return this.core.fetch('/api/futures/volume/footprint-history', 'get');
  }
}
...
export type { AggregatedLiquidationHistoryMetadataParam, AggregatedLiquidationHistoryResponse200, AggregatedLiquidationHistoryResponse400, AggregatedTakerBuysellVolumeHistoryMetadataParam, AggregatedTakerBuysellVolumeHistoryResponse200, AggregatedTakerBuysellVolumeHistoryResponse400, AggregatedTakerBuysellVolumeRatioMetadataParam, AggregatedTakerBuysellVolumeRatioResponse200, AggregatedTakerBuysellVolumeRatioResponse400, Ahr999Response200, Ahr999Response400, BitcoinBubbleIndexResponse200, BitcoinBubbleIndexResponse400, BitcoinEtfNetassetsHistoryMetadataParam, BitcoinEtfNetassetsHistoryResponse200, BitcoinEtfNetassetsHistoryResponse400, BitcoinEtfPremiumDiscountHistoryMetadataParam, BitcoinEtfPremiumDiscountHistoryResponse200, BitcoinEtfPremiumDiscountHistoryResponse400, BitcoinEtfsResponse200, BitcoinEtfsResponse400, BitcoinProfitableDaysResponse200, BitcoinProfitableDaysResponse400, BitcoinRainbowChartResponse200, BitcoinRainbowChartResponse400, BitfinexMarginLongShortMetadataParam, BitfinexMarginLongShortResponse200, BitfinexMarginLongShortResponse400, BorrowInterestRateMetadataParam, BorrowInterestRateResponse200, BorrowInterestRateResponse400, BullMarketPeakIndicatorResponse200, BullMarketPeakIndicatorResponse400, CoinbasePremiumIndexMetadataParam, CoinbasePremiumIndexResponse200, CoinbasePremiumIndexResponse400, CoinsMarketsMetadataParam, CoinsMarketsResponse200, CoinsMarketsResponse400, CoinsPriceChangeResponse200, CoinsPriceChangeResponse400, CoinsResponse200, CryptofearGreedindexResponse200, CryptofearGreedindexResponse400, CumulativeExchangeListMetadataParam, CumulativeExchangeListResponse200, CumulativeExchangeListResponse400, EnterpriseFundingrateOhlcHistoryMetadataParam, EnterpriseFundingrateOhlcHistoryResponse200, EnterpriseFundingrateOhlcHistoryResponse400, EnterpriseLiquidationAggregatedHeatmapMetadataParam, EnterpriseLiquidationAggregatedHeatmapModel2MetadataParam, EnterpriseLiquidationAggregatedHeatmapModel2Response200, EnterpriseLiquidationAggregatedHeatmapModel2Response400, EnterpriseLiquidationAggregatedHeatmapModel3MetadataParam, EnterpriseLiquidationAggregatedHeatmapModel3Response200, EnterpriseLiquidationAggregatedHeatmapModel3Response400, EnterpriseLiquidationAggregatedHeatmapResponse200, EnterpriseLiquidationAggregatedHeatmapResponse400, EnterpriseLiquidationHeatmapMetadataParam, EnterpriseLiquidationHeatmapModel2MetadataParam, EnterpriseLiquidationHeatmapModel2Response200, EnterpriseLiquidationHeatmapModel2Response400, EnterpriseLiquidationHeatmapModel3MetadataParam, EnterpriseLiquidationHeatmapModel3Response200, EnterpriseLiquidationHeatmapModel3Response400, EnterpriseLiquidationHeatmapResponse200, EnterpriseLiquidationHeatmapResponse400, EnterpriseLiquidationHistoryMetadataParam, EnterpriseLiquidationHistoryResponse200, EnterpriseLiquidationHistoryResponse400, EnterpriseOpeninterestOhlcHistoryMetadataParam, EnterpriseOpeninterestOhlcHistoryResponse200, EnterpriseOpeninterestOhlcHistoryResponse400, EtfDetailMetadataParam, EtfDetailResponse200, EtfDetailResponse400, EtfFlowsHistoryResponse200, EtfFlowsHistoryResponse400, EtfHistoryMetadataParam, EtfHistoryResponse200, EtfHistoryResponse400, EtfPriceOhlcHistoryMetadataParam, EtfPriceOhlcHistoryResponse200, EtfPriceOhlcHistoryResponse400, EthereumEtfFlowsHistoryResponse200, EthereumEtfFlowsHistoryResponse400, EthereumEtfListResponse200, EthereumEtfListResponse400, EthereumEtfNetassetsHistoryResponse200, EthereumEtfNetassetsHistoryResponse400, ExchangeBalanceChartMetadataParam, ExchangeBalanceChartResponse200, ExchangeBalanceChartResponse400, ExchangeBalanceListMetadataParam, ExchangeBalanceListResponse200, ExchangeBalanceListResponse400, ExchangeOnchainTransfersMetadataParam, ExchangeOnchainTransfersResponse200, ExchangeOnchainTransfersResponse400, ExchangeOpenInterestHistoryMetadataParam, ExchangeOpenInterestHistoryResponse200, ExchangeOpenInterestHistoryResponse400, ExchangeVolumeHistoryMetadataParam, ExchangeVolumeHistoryResponse200, ExchangeVolumeHistoryResponse400, FrArbitrageMetadataParam, FrArbitrageResponse200, FrArbitrageResponse400, FrExchangeListResponse200, FrExchangeListResponse400, FrOhlcHistroyMetadataParam, FrOhlcHistroyResponse200, FrOhlcHistroyResponse400, FuturesAggregatedOrderbookHistoryMetadataParam, FuturesAggregatedOrderbookHistoryResponse200, FuturesAggregatedOrderbookHistoryResponse400, FuturesLiquidationAggregatedHistoryMetadataParam, FuturesOrderbookHistoryMetadataParam, FuturesOrderbookHistoryResponse200, FuturesOrderbookHistoryResponse400, FuturesRsiListResponse200, FuturesRsiListResponse400, GetApiarticlelistMetadataParam, GetApicalendarcentralBankActivitiesMetadataParam, GetApicalendareconomicDataMetadataParam, GetApicalendarfinancialEventsMetadataParam, GetApichainwhaleTransferMetadataParam, GetApienterpricefuturesglobalLongShortAccountRatiohistoryMetadataParam, GetApienterprise1MetadataParam, GetApienterprise1Response200, GetApienterprise1Response400, GetApienterprisefuturesliquidationaggregateHeatmap1MetadataParam, GetApienterprisefuturesliquidationaggregateHeatmap1Response200, GetApienterprisefuturesliquidationaggregateHeatmap1Response400, GetApienterprisefuturesliquidationheatmap1MetadataParam, GetApienterprisefuturesliquidationheatmap1Response200, GetApienterprisefuturesliquidationheatmap1Response400, GetApienterprisefuturesliquidationhistoryMetadataParam, GetApietfethereumflowHistory1Response200, GetApietfethereumflowHistory1Response400, GetApietfsolanaflowHistory1Response200, GetApietfsolanaflowHistory1Response400, GetApiexchangeassetsMetadataParam, GetApiexchangeassetsResponse200, GetApifuturesbasishistoryMetadataParam, GetApifuturesbasishistoryResponse200, GetApifuturesindicatorsema1MetadataParam, GetApifuturesindicatorsema2MetadataParam, GetApifuturesindicatorsma1MetadataParam, GetApifuturesindicatorsrsi1MetadataParam, GetApifuturesliquidationmaxPainMetadataParam, GetApifuturesv2NetPositionhistoryMetadataParam, GetApifutureswhaleIndexhistoryMetadataParam, GetApihyperliquidpositionMetadataParam, GetApiindexbitcoinSthSoprResponse200, GetApispotorderbookhistoryMetadataParam, GetApispotorderbooklargeLimitOrderMetadataParam, GetApispotorderbooklargeLimitOrderResponse200, GetApispotpricehistoryMetadataParam, GetApispotpricehistoryResponse200, GetEndpointMetadataParam, GetNewEndpoint1MetadataParam, GetNewEndpointMetadataParam, GlobalLongshortAccountRatioMetadataParam, GlobalLongshortAccountRatioResponse200, GlobalLongshortAccountRatioResponse400, GoldenRatioMultiplierResponse200, GoldenRatioMultiplierResponse400, GrayscaleHoldingListResponse200, GrayscaleHoldingListResponse400, GrayscalePremiumHistoryMetadataParam, GrayscalePremiumHistoryResponse200, GrayscalePremiumHistoryResponse400, HongKongBitcoinEtfFlowHistoryResponse200, HongKongBitcoinEtfFlowHistoryResponse400, HyperliquidWhaleAlertResponse200, HyperliquidWhaleAlertResponse400, HyperliquidWhalePositionResponse200, HyperliquidWhalePositionResponse400, InfoMetadataParam, InfoResponse200, InfoResponse400, InstrumentsMetadataParam, InstrumentsResponse200, LargeLimitOrderHistory2MetadataParam, LargeLimitOrderHistory2Response200, LargeLimitOrderHistory2Response400, LargeOrderMetadataParam, LargeOrderResponse200, LargeOrderResponse400, LargeOrderbookCopy2MetadataParam, LargeOrderbookCopy2Response200, LargeOrderbookCopy2Response400, LargeOrderbookHistoryMetadataParam, LargeOrderbookHistoryResponse200, LargeOrderbookMetadataParam, LargeOrderbookResponse200, LargeOrderbookResponse400, LiquidationAggregateHeatmapMetadataParam, LiquidationAggregateHeatmapModel2MetadataParam, LiquidationAggregateHeatmapModel2Response200, LiquidationAggregateHeatmapModel2Response400, LiquidationAggregateHeatmapResponse200, LiquidationAggregateHeatmapResponse400, LiquidationAggregatedHeatmapModel3MetadataParam, LiquidationAggregatedHeatmapModel3Response200, LiquidationAggregatedHeatmapModel3Response400, LiquidationAggregatedMapMetadataParam, LiquidationAggregatedMapResponse200, LiquidationAggregatedMapResponse400, LiquidationCoinListMetadataParam, LiquidationCoinListResponse200, LiquidationCoinListResponse400, LiquidationExchangeListMetadataParam, LiquidationExchangeListResponse200, LiquidationExchangeListResponse400, LiquidationHeatmapMetadataParam, LiquidationHeatmapModel2MetadataParam, LiquidationHeatmapModel2Response200, LiquidationHeatmapModel2Response400, LiquidationHeatmapModel3MetadataParam, LiquidationHeatmapModel3Response200, LiquidationHeatmapModel3Response400, LiquidationHeatmapResponse200, LiquidationHeatmapResponse400, LiquidationHistoryMetadataParam, LiquidationHistoryResponse200, LiquidationHistoryResponse400, LiquidationMapMetadataParam, LiquidationMapResponse200, LiquidationMapResponse400, LiquidationOrderMetadataParam, LiquidationOrderResponse200, LiquidationOrderResponse400, OiExchangeHistoryChartMetadataParam, OiExchangeHistoryChartResponse200, OiExchangeHistoryChartResponse400, OiExchangeListMetadataParam, OiExchangeListResponse200, OiExchangeListResponse400, OiOhlcAggregatedCoinMarginHistoryMetadataParam, OiOhlcAggregatedCoinMarginHistoryResponse200, OiOhlcAggregatedCoinMarginHistoryResponse400, OiOhlcAggregatedHistoryMetadataParam, OiOhlcAggregatedHistoryResponse200, OiOhlcAggregatedHistoryResponse400, OiOhlcAggregatedStablecoinMarginHistoryMetadataParam, OiOhlcAggregatedStablecoinMarginHistoryResponse200, OiOhlcAggregatedStablecoinMarginHistoryResponse400, OiOhlcHistroyMetadataParam, OiOhlcHistroyResponse200, OiOhlcHistroyResponse400, OiWeightOhlcHistoryMetadataParam, OiWeightOhlcHistoryResponse200, OiWeightOhlcHistoryResponse400, OptionMaxPainMetadataParam, OptionMaxPainResponse200, OptionMaxPainResponse400, OrderbookHeatmapMetadataParam, PairsMarketsMetadataParam, PairsMarketsResponse200, PairsMarketsResponse400, PiResponse200, PiResponse400, PriceOhlcHistoryMetadataParam, PriceOhlcHistoryResponse200, PuellMultipleResponse200, PuellMultipleResponse400, SpotAggregatedHistoryMetadataParam, SpotAggregatedHistoryResponse200, SpotAggregatedHistoryResponse400, SpotAggregatedTakerBuysellHistoryMetadataParam, SpotAggregatedTakerBuysellHistoryResponse200, SpotAggregatedTakerBuysellHistoryResponse400, SpotCoinsMarketsMetadataParam, SpotCoinsMarketsResponse200, SpotCoinsMarketsResponse400, SpotOrderbookHistoryMetadataParam, SpotOrderbookHistoryResponse200, SpotOrderbookHistoryResponse400, SpotPairsMarketsMetadataParam, SpotPairsMarketsResponse200, SpotPairsMarketsResponse400, SpotSuportedExchangePairsResponse200, SpotSuportedExchangePairsResponse400, SpotSupportedCoinsResponse200, SpotSupportedCoinsResponse400, SpotTakerBuysellRatioHistoryMetadataParam, SpotTakerBuysellRatioHistoryResponse200, SpotTakerBuysellRatioHistoryResponse400, StablecoinMarketcapHistoryResponse200, StablecoinMarketcapHistoryResponse400, StockFlowResponse200, StockFlowResponse400, TakerBuysellVolumeExchangeListMetadataParam, TakerBuysellVolumeExchangeListResponse200, TakerBuysellVolumeExchangeListResponse400, TakerBuysellVolumeMetadataParam, TakerBuysellVolumeResponse200, TakerBuysellVolumeResponse400, TopLongshortAccountRatioMetadataParam, TopLongshortAccountRatioResponse200, TopLongshortAccountRatioResponse400, TopLongshortPositionRatioMetadataParam, TopLongshortPositionRatioResponse200, TopLongshortPositionRatioResponse400, TowHundredWeekMovingAvgHeatmapResponse200, TowHundredWeekMovingAvgHeatmapResponse400, TowYearMaMultiplierResponse200, TowYearMaMultiplierResponse400, VolWeightOhlcHistoryMetadataParam, VolWeightOhlcHistoryResponse200, VolWeightOhlcHistoryResponse400 } from './types';
