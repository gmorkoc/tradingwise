        ...
        (() => {
          ...
          const insight =
            delta === 0
              ...
              : up
                ...
                : t("priceTicker.insightDown", {
                    coin,
                    pct: deltaAbs.toFixed(3),
                  });
          ...
          return (
            <div
              ...
              onKeyDown={(e) => e.key === "Escape" && setPriceTicker(false)}
              tabIndex={-1}
            >
              <div className="pticker-bg-symbol">
                {COIN_ICONS[coin] ?? coin[0]}
              </div>
              ...
              <div className="pticker-top-actions">
                ...
                <button
                  className="pticker-close"
                  onClick={() => setPriceTicker(false)}
                  aria-label="Exit"
                >
                  <svg
                    width="15"
              ...
              <div className="pticker-inner">
                ...
                <div className="pticker-coin-name">
                  <span className="pticker-coin-sym">
                    {COIN_ICONS[coin] ?? coin[0]}
                  </span>
                  {coin}
